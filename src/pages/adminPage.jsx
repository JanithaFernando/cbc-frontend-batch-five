...
export default function AdminPage(){
    ...
    return(
        <div className="w-full h-screen flex bg-accent">
            <div className="w-[300px] h-full text-accent font-bold text-xl flex flex-col bg-white ">
            ...
            <div className="w-[calc(100%-300px)] h-full border-accent border-4 rounded-xl bg-white">
                <Routes path="/*">
